...
export const data = [
  {
    id: 1,
    avatar: 'user.png',
    full_name: '0x0000000000000000000000000000000000000000',
    amount: 0
  },
  {
    id: 2,
...
export const basicColumns = [
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        {row.avatar === '' ? (
          ...
          <Avatar img={require(`@src/assets/images/avatars/${row.avatar}`).default} />
        )}
        <div className='user-info ml-1'>
          <span className='d-block font-weight-bold'>{row.full_name}</span>
        </div>
      </div>
    )
  },
  {
    ...
    cell: row => (
      <div className='d-flex align-items-center'>
        <div>
          <span style={{ fontFamily: 'monospace' }} className= 'mr-1'>{row.amount}</span>
        </div>
        {row.id === 1 ? (<img src={GoldBadge} alt='gold' width='20' />) :
          (row.id === 2 ? (<img src={SilverBadge} alt='silver' width='20' />) :
            (row.id === 3 ? (<img src={BronzeBadge} alt='bronze' width='20' />) :
              (<></>)))}
      </div>
    )
  }
